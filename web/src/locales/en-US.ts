const enUS = {
  ...
  'nodes.public_key': 'Public Key',
  'nodes.short_id': 'Short ID',
  'nodes.allow_insecure': 'Allow Insecure (skip certificate verification)',
  'nodes.core_selection': 'Core Selection',
  'nodes.auto': 'Auto',
  'nodes.manual': 'Manual',
  'nodes.recommended_core': 'Recommended',
  'nodes.manual_core': 'Manual Core',
  'nodes.no_core_available': 'No core available',
  'nodes.core_installed_suffix': ' ✓',
  'nodes.core_not_installed_suffix': ' (not installed)',
  'nodes.also_supported': 'Also supported:',
  'nodes.activated': 'Activated',
  'nodes.click_to_activate': 'Click to activate',
  ...
  'auth.totp': 'TOTP Code',
  'auth.totp_placeholder': 'Leave empty if 2FA is not enabled',
  'auth.login_failed': 'Invalid username or password',
  'auth.totp_required': 'TOTP code is required',
  'auth.totp_invalid': 'Invalid TOTP code',
  'nav.account': 'Account',
  ...
  'account.submit_password': 'Submit',
  ...
  'account.totp_scan': 'Scan QR code with your Authenticator app',
  'account.totp_secret_label': 'Secret (manual entry)',
  'account.totp_enter_code': 'Enter 6-digit code to confirm',
  'account.totp_confirm_enable': 'Confirm Enable',
  'account.totp_enabled_ok': 'Two-factor authentication enabled',
  'account.totp_disable_confirm': 'Enter your TOTP code to disable 2FA',
  'account.totp_disable_btn': 'Disable',
  'account.totp_enable_btn': 'Enable',
  'account.totp_custom_secret': 'Custom Secret',
  'account.totp_custom_secret_placeholder': 'Leave empty for random secret',
  'account.totp_disabled_ok': 'Two-factor authentication disabled',
  'account.sessions': 'Session Management',
  'account.logout': 'Sign Out',
  'account.revoke_all': 'Sign Out All Devices',
  'account.revoke_all_confirm': 'Sign out all devices? This will immediately invalidate all active sessions.',
  'account.sessions_revoked': 'All devices have been signed out',
